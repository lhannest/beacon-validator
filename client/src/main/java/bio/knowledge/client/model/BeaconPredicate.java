...
public class BeaconPredicate {
  ...
  **/
   ...
   * @return edgeLabel
  **/
  @ApiModelProperty(example = "null", value = "human readable name of a 'minimal' Biolink model predicate relation terms (see [Biolink Model](https://biolink.github.io/biolink-model) for the full list of terms) ")
   ...
   * @return relation
  **/
  @ApiModelProperty(example = "null", value = "human readable name of a 'maximal' Biolink model predicate relation terms (see [Biolink Model](https://biolink.github.io/biolink-model) for the full list of terms) ")
